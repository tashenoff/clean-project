      ...
      <div className="bg-white p-6 rounded-lg shadow-sm mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="font-medium">{user?.role === 'customer' ? 'Customer' : 'Executor'}</p>
          </div>
          ...
          {user?.role === 'executor' && user?.executor_profile && (
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-1">Experience Level</h3>
              <p className="font-medium">{user.executor_profile.experience_level || 'BEGINNER'}</p>
            </div>
          )}
        </div>
      </div>
